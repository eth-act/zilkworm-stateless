...
// Optimized memcpy for rv64ima (ZisK zkVM).
//
...
//      loads directly, which may crash in bare-metal environments where
//      ld/sd require 8-byte alignment.
...
// The rv64ima superset is binary-compatible with rv64im for integer ops.
//
