// Copied verbatim from eth-act/zkvm-standards (standards/c-interface-accelerators/),
// which is dual-licensed Apache-2.0/MIT by its authors.
...
typedef zkvm_bytes_32 zkvm_ripemd160_hash;  /* 20-byte hash padded to 32 bytes, first 12 bytes are zero */
